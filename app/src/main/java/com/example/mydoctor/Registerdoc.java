                        ...
                        if (task.isSuccessful()) {
                            ...
                            FirebaseDatabase.getInstance().getReference("Users")
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()){
                                        Toast.makeText(Registerdoc.this, "User has been registred successfully", Toast.LENGTH_SHORT).show();

                                    }
                                    else {
                                        Toast.makeText(Registerdoc.this, "Error!" + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
